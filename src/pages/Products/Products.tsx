...
const Products: React.FC = () => {
  ...
  const [productDelete, setProductDelete] = useState<IDeleteModal>({
    id: null,
    delete: false,
  });
  ...
  const toggleDeleteModal = (id: number | null = null) => {
    setProductDelete({ delete: !productDelete.delete, id });
  };

  return (
    <AppLayout>
      <>
        <Modal isOpen={productDelete.delete} close={toggleDeleteModal}>
          <DeleteProduct id={productDelete.id} close={toggleDeleteModal} />
        </Modal>
